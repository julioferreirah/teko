...
const valueProps = [
  { icon: Check,        title: "Para qualquer porte",       desc: "Funciona em ambulatórios, clínicas, UPAs e hospitais de grande complexidade." },
  { icon: Zap,          title: "Operacional em dias",       desc: "Sem treinamento presencial. Médicos adotam porque é via WhatsApp." },
  { icon: DollarSign,   title: "Retorno no primeiro mês",   desc: "A redução de erros nos repasses cobre o investimento logo no mês 1." },
];
...
export function CtaSection() {
  ...
  return (
    <section ref={ref} id="contato" className="py-20 md:py-28 bg-teko-light">
      <div className="mx-auto max-w-6xl px-5">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-start">
          ...
          >
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-teko-primary/20 bg-white px-4 py-1.5">
              <span className="text-xs font-semibold uppercase tracking-wider text-teko-primary">Fale com a gente</span>
            </div>
            ...
            <div className="flex flex-col gap-4">
              {valueProps.map((vp, i) => (
                ...
                >
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-teko-primary/15">
                    <vp.icon size={17} className="text-teko-primary" />
                  </div>
                  <div>
                    <p className="text-sm font-bold text-gray-800">{vp.title}</p>
                    <p className="text-sm text-gray-500">{vp.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          >
            <div className="relative rounded-2xl border border-teko-primary/20 p-px">
              ...
              <div className="relative rounded-2xl bg-white p-6 md:p-8 shadow-sm">
                <h3 className="mb-5 font-[var(--font-geist)] text-xl font-bold text-gray-900">Agendar Demonstração</h3>
                <div
